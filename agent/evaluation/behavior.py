...
class BehaviorEvaluator(BaseEvaluator):
    ...
    def generate(self, n: int = 0, output_path: str | None = None) -> list[dict]:
        ...
        cases = [
            ...
            },
            {
                ...
                "rationale": "Project-internal technical question must use rag_search; an exploratory rag_explore first is acceptable per the system prompt.",
            },
            {
                ...
                "rationale": "Must use rag_search with a file_type filter; an exploratory rag_explore first is acceptable.",
            },
            {
    ...
    _missing_required_tools = staticmethod(missing_required_tools)
